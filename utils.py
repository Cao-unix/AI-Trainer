...
def get_landmark_features(kp_results, feature, frame_width, frame_height):
    if feature == 'nose':
        ...
        heel_coord = get_landmark_array(kp_results, dict_features[feature]['heel'], frame_width, frame_height)

        return shldr_coord, elbow_coord, wrist_coord, hip_coord, knee_coord, ankle_coord, foot_coord, heel_coord
